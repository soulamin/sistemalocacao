            ...
            <div class="grid gap-5">
                ...
                <div class="dashboard-metric-list">
                    <div class="dashboard-metric">
                        ...
                        <div class="dashboard-metric-value"><?php echo e(number_format($productCount, 0, ',', '.')); ?></div>
                    </div>
                    <div class="dashboard-metric">
                        <div class="dashboard-metric-label">Clientes</div>
                        <div class="dashboard-metric-value"><?php echo e(number_format($clientCount, 0, ',', '.')); ?></div>
                    </div>
                    <div class="dashboard-metric">
                        <div class="dashboard-metric-label">Locações ativas</div>
                        <div class="dashboard-metric-value"><?php echo e(number_format($activeRentalCount, 0, ',', '.')); ?></div>
                    </div>
                </div>
            </div>
            <div class="dashboard-side">
                <div class="grid gap-4">
                    <div>
                        ...
                        <div class="dashboard-side-rate"><?php echo e($occupancyRate); ?>%</div>
                    </div>
                    <div class="dashboard-progress">
                        <span style="width: <?php echo e($occupancyRate); ?>%"></span>
                    </div>
                    <div class="dashboard-side-list">
                        <div class="dashboard-side-item">
                            <span>Receita ativa</span>
                            <strong>R$ <?php echo e(number_format((float) $activeRevenue, 2, ',', '.')); ?></strong>
                        </div>
                        <div class="dashboard-side-item">
                            <span>Contratos em andamento</span>
                            <strong><?php echo e(number_format($activeRentalCount, 0, ',', '.')); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\conlkv\SISTEMA_LOCAÇÃO\backend\resources\views/filament/pages/dashboard-header.blade.php ENDPATH**/ ?>